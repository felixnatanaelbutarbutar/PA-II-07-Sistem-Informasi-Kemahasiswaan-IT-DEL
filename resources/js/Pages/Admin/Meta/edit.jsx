...
export default function Edit({ auth, permissions, userRole, menu, meta }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setNotification({
                show: true,
                type: 'success',
                message: 'Meta berhasil diperbarui!',
            });
            ...
            if (error.response && error.response.status === 422) {
                ...
                setNotification({
                    show: true,
                    type: 'error',
                    message: 'Gagal memperbarui meta: ' + (error.response?.data?.message || 'Terjadi kesalahan.'),
                });
            }
            setIsSubmitting(false);
        }
            ...
            <div className="py-12 max-w-5xl mx-auto px-6 sm:px-8">
                ...
                <div className="backdrop-blur-sm bg-white/80 rounded-2xl shadow-lg p-6 mb-8 border border-gray-200/50 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Perbarui data meta</p>
                    </div>
                    <Link
