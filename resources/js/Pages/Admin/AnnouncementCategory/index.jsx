...
export default function Index({ auth, userRole, permissions, menu, categories = [], filters = {}, flash }) {
    ...
    const handleDeleteClick = (category_id) => {
        console.log('Handle delete click:', { category_id, timestamp: new Date().toISOString() });
    ...
    const confirmDelete = () => {
        if (!categoryIdToDelete) {
            console.error('No category ID provided for delete', { timestamp: new Date().toISOString() });
            setNotificationMessage('Gagal menghapus kategori: ID kategori tidak valid.');
            setNotificationType('error');
            setShowNotification(true);
        ...
        setIsDeleting(true);
        router.post(route('admin.announcement-category.destroy', categoryIdToDelete), {}, {
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
                setNotificationMessage('Kategori dan pengumuman terkait berhasil dihapus.');
                setNotificationType('success');
                setShowNotification(true);
                setIsDeleting(false);
                setShowDeleteModal(false);
    ...
    return (
        <AdminLayout user={auth.user} userRole={userRole} permissions={permissions} navigation={menu}>
            <Head title="Kelola Kategori Pengumuman" />
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md transform transition-all duration-300 scale-100">
                        ...
                        <p className="text-red-600 font-semibold text-center mb-6 flex items-center justify-center">
                            Seluruh pengumuman yang terkait dengan kategori ini juga akan dihapus.
                        </p>
            ...
            <div className="py-10 max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div>
                            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                                Manajemen Kategori Pengumuman
                            </h1>
                            <p className="text-gray-500 mt-1">Kelola kategori pengumuman untuk website</p>
                        </div>
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                            ...
                            <Link
                                href={route('admin.announcement-category.create')}
                ...
                {viewMode === 'table' && localCategories.length > 0 && (
                                                ...
                                                >
                                                    ...
                                                    {openDropdownId === category.category_id && (
                                                        ...
                                                        >
                                                            <div className="py-1">
                                                                <Link
                                                                    href={route('admin.announcement-category.edit', category.category_id)}
                ...
                {viewMode === 'grid' && localCategories.length > 0 && (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-lg border border-gray-100">
                        ...
                        <p className="text-gray-500 text-center max-w-md mb-6">
                            {searchTerm
                                ...
                                : 'Silahkan tambahkan kategori baru untuk mulai mengelola kategori pengumuman.'}
                        </p>
                        {searchTerm ? (
                            <button
