    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Get categories list
                const categoriesResponse = await fetch('http://157.15.124.200/api/announcement-categories');
                ...
                // Get meta data
                const metaResponse = await fetch('http://157.15.124.200/api/meta/pengumuman');
                if (!metaResponse.ok) {
