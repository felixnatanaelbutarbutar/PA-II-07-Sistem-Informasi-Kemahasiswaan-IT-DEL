...
class FormController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Apply status filter with explicit table reference
                ...
                try {
                    return [
                        ...
                        'start_date' => $form->settings?->submission_start
                            ? (is_string($form->settings->submission_start)
                                ? $form->settings->submission_start
                                : Carbon::parse($form->settings->submission_start)->toDateTimeString())
                            : '-',
                        'close_date' => $form->settings?->submission_deadline
                            ? (is_string($form->settings->submission_deadline)
                                ? $form->settings->submission_deadline
