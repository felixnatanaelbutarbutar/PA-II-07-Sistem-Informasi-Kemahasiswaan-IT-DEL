...
export default function CarouselEdit({ auth, userRole, permissions, menu, carousel }) {
    ...
    const [previewImage, setPreviewImage] = useState(carousel.image_path ? `/storage/${carousel.image_path}` : null);
        ...
        try {
            ...
            if (error.response && error.response.status === 422) {
                ...
                setNotification({
                    show: true,
                    type: 'error',
                    message: 'Gagal memperbarui carousel: ' + (error.response?.data?.message || 'Terjadi kesalahan.'),
                });
            }
            setIsSubmitting(false);
        }
            ...
            <div className="py-10 max-w-7xl mx-auto px-4 sm:px-6">
                <div className="backdrop-blur-sm bg-white/80 rounded-2xl shadow-lg p-6 mb-8 border border-gray-200/50 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Perbarui data carousel untuk halaman utama website</p>
                    </div>
                    <Link
                            ...
                            <div className="space-y-2">
                                ...
                                {previewImage && (
                                    <div className="mt-4">
                                        ...
                                        {previewImage.endsWith('.svg') || previewImage.includes('.svg') ? (
                                            <object
                                                data={previewImage}
                                                type="image/svg+xml"
