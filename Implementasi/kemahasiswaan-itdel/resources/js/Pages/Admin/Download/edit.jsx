...
export default function DownloadEdit({ auth, userRole, permissions, navigation, download, categories }) {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="file" className="block text-sm font-medium text-gray-700">
                                    File Baru (PDF, DOC, DOCX, XLS, XLSX) - Kosongkan jika tidak ingin mengganti
                                </label>
                                <input
                                    type="file"
                                    name="file"
