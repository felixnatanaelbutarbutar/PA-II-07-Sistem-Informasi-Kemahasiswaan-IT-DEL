...
export default function Edit({ auth, userRole, permissions, menu, category, flash }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(route('admin.scholarship-category.update', category.category_id), values, {
                headers: {
            ...
            setTimeout(() => {
                router.visit(route('admin.scholarship-category.index'));
            }, 1500);
        } catch (error) {
    ...
    return (
        <AdminLayout user={auth.user} userRole={userRole} permissions={permissions} navigation={menu}>
            <Head title="Edit Kategori Beasiswa" />
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div>
                            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                                Edit Kategori Beasiswa
                            </h1>
                            <p className="text-gray-500 mt-1">Perbarui informasi kategori beasiswa</p>
                        </div>
                        <Link
                            href={route('admin.scholarship-category.index')}
