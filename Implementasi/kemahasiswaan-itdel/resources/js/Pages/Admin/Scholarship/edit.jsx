...
export default function Edit({ auth, permissions, userRole, menu, scholarship, categories }) {
    if (!auth?.user || !scholarship || !categories) {
        return (
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setNotification({
                show: true,
                type: 'error',
                message: 'Gagal memperbarui beasiswa. Silakan coba lagi.'
            });
            ...
            <div className="py-12 max-w-5xl mx-auto px-6 sm:px-8">
                <div className="bg-white rounded-xl shadow-md p-8 mb-8">
                    <div className="flex items-center justify-between mb-8">
                        <h1 className="text-3xl font-bold text-gray-800">Edit Beasiswa</h1>
                        <Link
