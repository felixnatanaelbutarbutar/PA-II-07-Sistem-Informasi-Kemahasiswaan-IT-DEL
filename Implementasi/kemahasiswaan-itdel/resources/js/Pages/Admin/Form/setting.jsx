...
export default function Index({ auth, userRole, permissions, menu, forms = [], scholarships = [], flash }) {
    ...
    const confirmDelete = () => {
        if (formIdToDelete) {
            setIsDeleting(true);
            router.post(
                route('form.destroy', { form: formIdToDelete }),
                {},
                {
                    preserveState: true,
                    preserveScroll: true,
    ...
    const filteredForms = forms.filter((item) =>
        ...
        (item.scholarship && item.scholarship.name?.toLowerCase().includes(searchTerm.toLowerCase()))
    );
                                ...
                                >
                                    <div className="p-5 flex flex-col flex-grow">
                                        ...
                                        <div className="text-sm text-gray-600 mb-2">
                                            ...
                                            {form.scholarship ? form.scholarship.name : 'Tanpa Beasiswa'}
                                        </div>
                                        ...
                                        <div className="flex justify-between items-center mt-auto pt-3 border-t border-gray-100">
                                            <Link
                                                href={route('form.edit', form.form_id)}
