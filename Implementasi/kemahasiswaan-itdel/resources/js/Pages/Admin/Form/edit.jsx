...
export default function Edit({ auth, permissions, userRole, menu, scholarships, form }) {
    ...
    useEffect(() => {
        ...
        console.log('Ziggy Routes:', window.Ziggy?.routes || 'Ziggy routes not loaded');
    ...
    const handleSubmit = (e) => {
        ...
        // Fallback URL if route('form.update') is not found
        const updateUrl = route('admin.form.update', form.form_id, false) || `/admin/form/${form.form_id}/update`;
                                                ...
                                                {(field.options ? field.options.split(',') : []).map((option, optIndex) => (
                                                    <div key={optIndex} className="flex items-center space-x-2 mb-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="text-gray-500 hover:text-red-600"
                                                            disabled={(field.options ? field.options.split(',').length : 0) <= 1}
                                                        >
                                                            <svg
                                                                className="w-5 h-5"
                                                                fill="none"
