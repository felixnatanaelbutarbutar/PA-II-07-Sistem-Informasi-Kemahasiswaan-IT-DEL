...
export default function Index({ auth, userRole, permissions, menu, forms = [], scholarships = [], flash }) {
    ...
    useEffect(() => {
        setLocalForms(Array.isArray(forms) ? forms : []); // Ensure forms is an array
    }, [forms]);
    ...
    const confirmDelete = () => {
        ...
        router.delete(route('admin.form.destroy', formIdToDelete), {
            ...
            onSuccess: () => {
                ...
                setNotificationType('success');
                setShowNotification(true);
                setLocalForms(localForms.filter((form) => form.form_id !== formIdToDelete));
                setIsDeleting(false);
                setShowDeleteModal(false);
                setFormIdToDelete(null);
            },
                    ...
                    setLocalForms(
                        localForms.map((form) =>
                            form.form_id === form_id
                                ? { ...form, is_active: !is_active, status: !is_active ? 'Aktif' : 'Non-Aktif' }
                                : form
                        )
                    );
                },
    ...
    const filteredForms = localForms.filter(
        (item) =>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                <div className="relative flex-grow md:flex-grow-0 md:w-64">
                                    <input
                                        type="text"
                                        placeholder="Cari formulir atau beasiswa..."
                                ...
                                >
                                    <div className="p-5 flex flex-col flex-grow">
                                        ...
                                        <div className="text-sm text-gray-600 mb-2">
                                            <span className="font-medium">Jenis Beasiswa:</span>{' '}
                                        ...
                                        <div className="text-sm text-gray-600 mb-2">
                                            ...
                                            {form.open_date
                                                ? new Date(form.open_date).toLocaleDateString('id-ID', {
                                                      day: '2-digit',
                                                      month: '2-digit',
                                                      year: 'numeric',
                                                  })
                                        ...
                                        <div className="flex flex-col gap-2 mt-auto pt-3 border-t border-gray-100">
                                            ...
                                            <Link
                                                href={`${route('admin.form.settings', form.form_id)}?tab=settings`}
                                        ...
                                        <tr key={form.form_id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium min-w-[150px]">
                                                <div className="flex flex-col gap-2">
                                                    <Link
                                                        href={route('admin.form.edit', form.form_id)}
                                                        className="flex items-center text-blue-600 hover:text-blue-700 transition px-3 py-1 rounded-md hover:bg-blue-50"
                                                    >
                                                        <svg
                                                            className="w-4 h-4 mr-1"
                                                            fill="none"
                                                    ...
                                                    <Link
                                                        href={`${route('admin.form.settings', form.form_id)}?tab=settings`}
                                                        className="flex items-center text-green-600 hover:text-green-700 transition px-3 py-1 rounded-md hover:bg-green-50"
                                                    >
                                                        <svg
                                                            className="w-4 h-4 mr-1"
                                                            fill="none"
                                                    ...
                                                    <button
                                                        onClick={() => handleDeleteClick(form.form_id)}
                                                        className="flex items-center text-red-600 hover:text-red-700 transition px-3 py-1 rounded-md hover:bg-red-50"
                                                        disabled={isDeleting}
                                                    >
                                                        <svg
                                                            className="w-4 h-4 mr-1"
                    ...
                    {filteredForms.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-lg border border-gray-100">
                            ...
                            <p className="text-gray-500 text-center max-w-md mb-6">
                                Belum ada formulir beasiswa yang dibuat. Mulai dengan membuat formulir baru untuk program beasiswa Anda.
                            </p>
                            <Link
                                href={route('admin.form.create')}
...
export default function Index({ auth, userRole, permissions, menu, forms = [], scholarships = [], flash }) {
    ...
    const confirmDelete = () => {
        if (formIdToDelete) {
            setIsDeleting(true);
            router.post(route('admin.form.destroy', formIdToDelete), {}, {
                preserveState: true,
                preserveScroll: true,
                onError: (errors) => {
                    setNotificationMessage('Gagal menghapus formulir: ' + (errors.error || 'Terjadi kesalahan.'));
                                ...
                                >
                                    <div className="p-5 flex flex-col flex-grow">
                                        ...
                                        <div className="flex flex-col gap-2 mt-auto pt-3 border-t border-gray-100">
                                            ...
                                            <Link
                                                href={`${route('admin.form.edit', form.form_id)}?tab=settings`}
                                                className="flex items-center text-green-600 hover:text-green-700 transition group-hover:scale-105 px-2 py-1 rounded-md hover:bg-green-50"
                                            >
                                                <svg
                                                    className="w-4 h-4 mr-1"
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center ${
                                                    ...
                                                    form.is_active ? 'hover:bg-yellow-50' : 'hover:bg-teal-50'
                                                }`}
                                                disabled={isDeleting}
                                            >
                                                <svg
