                                ...
                                >
                                    <div
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            e.currentTarget.style.boxShadow = styles.cardHover.boxShadow;
                                            e.currentTarget.querySelector('a').style.background =
                                                styles.announcementCardButtonHover.background;
                                        }}
                                        onMouseLeave={(e) => {
                                            e.currentTarget.style.transform = 'none';
                                            e.currentTarget.style.boxShadow = '0 2px 8px rgba(0, 0, 0, 0.08)';
                                            e.currentTarget.querySelector('a').style.background =
                                                styles.announcementCardButton.background;
                                        }}
                                    >
                                        <div style={styles.announcementCardCategory}>
                                            {item.category ? item.category.category_name : 'Uncategorized'}
                                        </div>
                                        <div style={styles.announcementCardContent}>
                                            <h3 style={styles.announcementCardTitle}>
                                                <svg
                                                    style={styles.announcementMegaphoneIcon}
                                                    fill="none"
                                                    stroke="currentColor"
                                                    viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                >
                                                    <path
                                                        ...
                                                        strokeLinejoin="round"
                                                        strokeWidth={2}
                                                        d="M11 5.882v12.236a1 1 0 01-1.405.914l-3.59-1.795A1 1 0 015 18H3a1 1 0 01-1-1V7a1 1 0 011-1h2a1 1 0 01.996.877l3.59-1.795A1 1 0 0111 5.882zM15 12h6m-3-3v6"
                                                    />
                                                </svg>
                                                {item.title}
                                            </h3>
